...
function applyAutoIndent() {
    ...
    activeEditor.edit(editBuilder => {
        ...
        const range = new vscode.Range(new vscode.Position(lineNumber, 0), new vscode.Position(lineNumber, leadingWhitespaceLength));
